...
class PaymentProvider(models.Model):
    ...
    multisafepay_active_shopping_cart = fields.Boolean(
        string="BNPL Support",
        help="Activate this option to show the cart items on the MultiSafepay payment page, which is required to support BNPL."
        "Note: If is disabled, the payment methods which require shopping cart and usually named as BNPL, won't work: Riverty - Afterpay, in3, Klarna and Billink.",
        default=False,
    )
    ...
    def write(self, vals):
        ...
        :param vals: Dictionary of field values to write
    ...
    def _on_multisafepay_config_changed(
        ...
        :param old_state: Previous provider state
        :param new_state: New provider state ('enabled', 'test', 'disabled')
        :param state_changed: Whether the state field changed
        :param new_api_key: New API key value
        :param api_key_changed: Whether the API key field changed
        :return: None
        """
    ...
    def _on_sync_deactivate_unavailable_payment_method_codes(
        ...
        :param synced_payment_method_codes: Set of payment method codes currently returned by API
        :type synced_payment_method_codes: set
        :return: None
        """
    ...
    def _get_country_ids(self, country_codes):
        ...
        :param country_codes: List of ISO 3166-1 alpha-2 country codes (e.g., ['US', 'GB'])
    ...
    def _get_currency_ids(self, currency_codes):
        ...
        :param currency_codes: List of ISO 4217 currency codes (e.g., ['EUR', 'USD'])
